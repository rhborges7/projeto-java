...
public class Cliente extends Usuario {
	...
	public Cliente (String login, String senha,int tipo, String nome, String email, String telefone, Endereco endereco) {
		super(login,senha,tipo);
		this.nome = nome;
		this.email = email;
		this.telefone = telefone;
	...
	// INSERIR O ENDEREÇO NO VETOR
		...
		public String toString() {
			...
			retValue = "Informações sobre o Cliente : " + super.toString() + ENTER +  "Codigo do Cliente : " + codigoCliente + ENTER +  "\n Nome : " + nome + ENTER +  "\n Email : " + email + ENTER + "\n Telefone : "
